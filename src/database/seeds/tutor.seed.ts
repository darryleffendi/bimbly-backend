...
import { TeachingMethod } from '../../modules/bookings/entities/booking.entity';
...
const tutorData = [
  {
    ...
    profile: {
      ...
      teachingMethods: [TeachingMethod.ONLINE, TeachingMethod.OFFLINE],
      hourlyRate: 150000,
      averageRating: 4.9,
      totalReviews: 127,
      totalSessions: 450,
  ...
  },
  {
    ...
    profile: {
      ...
      gradeLevels: [10, 11, 12],
      teachingMethods: [TeachingMethod.ONLINE],
      hourlyRate: 175000,
      averageRating: 4.8,
      totalReviews: 89,
      totalSessions: 312,
  ...
  },
  {
    ...
    profile: {
      ...
      subjects: ['Ekonomi'],
      gradeLevels: [10, 11, 12],
      teachingMethods: [TeachingMethod.OFFLINE],
      hourlyRate: 145000,
      averageRating: 4.7,
      totalReviews: 83,
      totalSessions: 290,
...
async function seed() {
  ...
  for (const tutor of tutorData) {
    ...
    user.city = tutor.user.city;
    user.province = tutor.user.province;
